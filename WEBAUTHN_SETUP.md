...
- **Without certificates:** Runs on `http://localhost:8088` (WebAuthn features disabled)
...
- If certificates are missing: `http://localhost:8088` (WebAuthn disabled)
...
If the server starts on `http://localhost:8088` instead of HTTPS:
